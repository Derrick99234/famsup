...
import Hero from "../../assets/images/Gen Z-pana.png"
...
function HeroSection() {
  return (
    <div className="hero my-[70px] mxl:my-[50px]">
        <div className="welcome bg-[white] flex flex-col mxl:flex-row gap-[40px] mxl:gap-[0px] items-center mxl:justify-start justify-center">
          <div className="welcometxtbtn flex flex-col justify-center items-center mxl:justify-start mxl:items-start">
            <h2 className="text-myblack font-[700] font-Inter capitalize mxl:w-[80%] w-[90%]  text-[35px] sm:text-[45px] mxl:text-[50px] text-center mxl:text-start">
          ...
          <div className="welcomeimg sm:w-[100%] sm:flex sm:justify-center">
            <img src={Hero} alt="" />
          </div>
        </div>
      </div>
